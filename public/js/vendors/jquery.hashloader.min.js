...
hashDestination.data("destination")&&setTimeout(function(){a(".plugin-filter-elements").mixitup("remix","all")},1E3);"page-features"==hashDestination.data("destination")&&(a(".registro").slideDown(),a("html, body").animate({scrollTop:a(".registro").offset().top-70},1E3));"blog-details"==hashDestination.data("destination")&&(a("article").slideDown(),a("html, body").animate({scrollTop:a(".blog-details").offset().top-70},1E3));"remove"==hashDestination.data("action")?a(hashDestination).delay(500).slideUp(400,
